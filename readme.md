...
Crea un programma in Python con lo scopo di immagazzinare delle informazioni di alcuni studenti di una scuola superiore. Se non viene specificato il modo in cui salvarle, le informazioni vanno salvate in un file di testo, scrivendo ogni oggetto in formato json. 
 
Gli studenti hanno un identificativo (1,2,3..), un nome, un’età ed una classe (es “5D”). 

Ogni studente ha una pagella con delle valutazioni: la valutazione ha un’identificativo, un voto (dall’1 al 10) ed una materia (Inglese,Italiano,Matematica,Fisica); la pagella contiene il riferimento allo studente (l’identificativo) ed il riferimento delle valutazioni delle 4 materie. 

Creare le classi relative a studenti, pagelle e valutazioni.
